...
export default function ReportsPage() {
  ...
  const healthScore = (() => {
    try {
      const h = JSON.parse(localStorage.getItem('healthScoreHistory') || '[]')
  ...
  function handleExportPDF() {
    setExporting(true)
    try {
      openFinancialSummaryPDF({ monthlyData, categoryData, profile, netWorth, healthScore, goals })
    } finally {
    ...
    <AppLayout>
      <div className="flex items-start justify-between mb-8 gap-4 flex-wrap">
        <div>
          ...
          <p className="text-slate-400 text-sm">12-month history, spending breakdown, and financial summary export.</p>
        </div>
        {isPremium && (
          <button
      ...
      {isPremium ? (
        ...
        <PremiumGate
          feature="12-month income vs expenses chart"
          description="See your full year of income and spending in one view. Spot trends and plan ahead."
        >
          <div className="p-6">
            <h2 className="text-white font-semibold mb-1">Income vs Expenses — last 12 months</h2>
      ...
      {isPremium ? (
        ...
        <PremiumGate
          feature="savings rate trend"
          description="Track whether your savings rate is improving month-over-month."
        >
          <div className="p-6">
            <h2 className="text-white font-semibold mb-1">Savings rate trend — last 12 months</h2>
      ...
      {isPremium ? (
        <div className="glass rounded-2xl p-6 mb-6">
          ...
          {loading ? (
            ...
            <p className="text-slate-600 text-sm">No expense data yet — add some transactions to see your breakdown.</p>
          ) : (
        ...
        <PremiumGate
          feature="spending category breakdown"
          description="See exactly which categories are consuming the most of your budget over the full year."
        >
          <div className="p-6">
      ...
      {/* ── PDF CTA for free users ── */}
      {!isPremium && (
        <PremiumGate
          feature="financial summary PDF"
          description="Download a clean, printable PDF report of your full financial picture — income, expenses, savings goals, net worth, and retirement projection."
        >
