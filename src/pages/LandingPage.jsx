...
const FREE_FEATURES = [
  'Dashboard & spending charts', 'Manual transaction entry',
  'Budget tools (limits, 50/30/20)', 'Retirement calculator',
  'Debt payoff tracker', 'Savings goals',
  'Net worth tracker', 'Bills tracker',
  'Tax estimator', 'Financial leaderboard',
]
...
function CheckIcon({ color }) {
  return (
    <span className="w-4 h-4 rounded-full flex items-center justify-center shrink-0"
      style={{ background: color === 'cyan' ? 'rgba(0,212,255,0.15)' : 'rgba(124,58,237,0.2)' }}>
      <svg width="8" height="8" viewBox="0 0 10 10" fill="none"
        stroke={color === 'cyan' ? '#00d4ff' : '#a78bfa'} strokeWidth="2">
...
export default function LandingPage() {
  ...
  return (
    <div className="bg-space-900 text-white">
      ...
      {/* Scrollable content — fixed so it clips at the header's bottom edge */}
      <div ref={scrollRef}
        className="landing-scroll fixed inset-x-0 bottom-0 overflow-y-auto overflow-x-hidden"
        style={{ top: '77px' }}>
          ...
          <div className="glass rounded-3xl p-8" style={{ borderColor: 'rgba(0,212,255,0.15)' }}>
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
              ...
              <div className="flex gap-4 text-xs">
                {[['#00d4ff','Conservative'],['#7c3aed','Moderate'],['#e040fb','Aggressive']].map(([c,l]) => (
        ...
        <section id="features" className="relative z-10 px-6 py-20 max-w-6xl mx-auto">
          <h2 className="reveal text-3xl font-bold text-center mb-3">Everything you need</h2>
        ...
        <section id="pricing" className="relative z-10 px-6 py-20 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            {/* Free */}
            <div className="reveal reveal-d2 glass rounded-2xl p-8 flex flex-col gap-6"
            ...
            <div className="reveal reveal-d3 rounded-2xl p-8 flex flex-col gap-6 relative overflow-hidden"
              ...
              <ul className="flex flex-col gap-2.5 text-sm text-slate-300">
                <li className="text-slate-500 text-xs uppercase tracking-wider font-medium">Everything in Free, plus:</li>
        ...
        <section className="relative z-10 px-6 py-20 text-center">
          <div className="reveal glass rounded-3xl max-w-2xl mx-auto px-8 py-14"
